		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						type: 'string',
						default: '',
						description: 'Value of the alternate key. If this key field is itself a Lookup, provide either the related record\u2019s GUID or a JSON object of alternate key field/value pairs on the target table (e.g. {"emailaddress1": "a@b.com"}), which will be resolved to the GUID automatically.',
					},
				],
			},
		],
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						type: 'string',
						default: '',
						description: 'Value to match on. If this key field is itself a Lookup, provide either the related record\u2019s GUID or a JSON object of alternate key field/value pairs on the target table (e.g. {"emailaddress1": "a@b.com"}), which will be resolved to the GUID automatically.',
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						default: '',
						required: true,
						description: 'The value of the alternate key field. If this key field is itself a Lookup, provide either the related record\u2019s GUID or a JSON object of alternate key field/value pairs on the target table (e.g. {"emailaddress1": "a@b.com"}), which will be resolved to the GUID automatically.',
						placeholder: 'e.g. user@example.com',
					},
				],
			},
