...
#### [v0.7.2](https://github.com/wtyeung/n8n-nodes-ms-dataverse/compare/v0.6.4...v0.7.2)

> 27 February 2025

### Added
- **Assign Operation**: New operation to assign (change ownership of) a record to a user or team
  - Supports both GUID and UPN (email) lookup for users
  - Supports team name lookup
  - Works with both record ID and alternate keys
